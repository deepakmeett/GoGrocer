...
public class Recent_Adaptor extends RecyclerView.Adapter<Recent_Adaptor.ViewHolder> {
    
    Context context;
    List<Recent_Model.Datum> list;

    int num = 1;

    public Recent_Adaptor(Context context, List<Recent_Model.Datum> list) {
    ...
    @NonNull
    @Override
    public Recent_Adaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Recent_Adaptor.ViewHolder holder, int position) {
        Recent_Model.Datum model = list.get( position );
