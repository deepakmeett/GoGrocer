...
public class New_Adaptor extends RecyclerView.Adapter<New_Adaptor.ViewHolder> {
    
    Context context;
    List<New_Model.Datum> list;

    int num = 1;

    public New_Adaptor(Context context, List<New_Model.Datum> list) {
    ...
    @NonNull
    @Override
    public New_Adaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final New_Adaptor.ViewHolder holder, int position) {
        New_Model.Datum model = list.get( position );
